...
export default function Home({ feed }) {
  ...
  return (
    <div>
      <SEO
        title="Home"
        description="The Juke, Kings Heath is a place of comfort to enjoy craft beer, served at its finest."
      />
      <Carousel />
      <header className="text-light text-center container pt-3">
        <h2 className="fs-5 baskerville-font">
          Welcome To <br />
          <span className="h2 text-primary">The Juke, Kings Heath</span>
        </h2>
